...
const services = [
  { icon: <Car className="w-6 h-6 text-gray-800" />, label: 'Buy used car' },
  { icon: <DollarSign className="w-6 h-6 text-gray-800" />, label: 'Sell car' },
  { icon: <Car className="w-6 h-6 text-gray-800" />, label: 'New car' },
  { icon: <CreditCard className="w-6 h-6 text-gray-800" />, label: 'Car loan' },
  { icon: <CreditCard className="w-6 h-6 text-gray-800" />, label: 'Credit card' },
  { icon: <CheckCircle className="w-6 h-6 text-gray-800" />, label: 'Get car checked' },
  { icon: <AlertCircle className="w-6 h-6 text-gray-800" />, label: 'Pay challan' },
  { icon: <Grid className="w-6 h-6 text-gray-800" />, label: 'More' },
]

export function Home() {
  return (
    <div className="bg-gray-900 text-white relative overflow-hidden h-[500px]">
      {/* Background Image */}
      <div className="absolute inset-0 bg-cover bg-center opacity-80 mt-2 h-[400px]" 
