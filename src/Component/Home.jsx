...
export function Home() {
  return (
    <div className="  bg-gray-900 text-white relative overflow-hidden mt-[5px]">
      <div className="absolute inset-0 z-0">
        <img
          src="./src/Img/car.jpeg"
          // alt="Background"
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <main>
          <h1 className="text-4xl font-bold mb-8 text-black ">Your One-Stop Hub for Everything on Wheels</h1>
