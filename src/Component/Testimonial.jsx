...
const featuredTestimonials = [
  ...
  { name: 'Muskan Burde', role: 'Car Buyer', content: 'I will surely recommend CarsNagpur. Overall a very satisfying experience', image: '/placeholder.svg?height=100&width=100' },
]
...
const videoTestimonials = [
  { name: 'Rahul Sharma', role: 'Car Seller', thumbnail: '/placeholder.svg?height=200&width=300', videoUrl: '#' },
  { name: 'Priya Patel', role: 'Car Buyer', thumbnail: '/placeholder.svg?height=200&width=300', videoUrl: '#' },
  { name: 'Amit Singh', role: 'Car Seller', thumbnail: '/placeholder.svg?height=200&width=300', videoUrl: '#' },
]
