  ...
  return (
    <div className="bg-gray-50 min-h-screen ">
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        {/* Hero Section */}
        <div className='w-[1515px] ml-[-150px] mt-[-46px] '>
        <div className="bg-cover bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow-xl overflow-hidden mb-16  h-[500px]" style={{ backgroundImage: "url('https://st2.depositphotos.com/1071909/7421/i/450/depositphotos_74218783-stock-photo-family-life-insurance-and-policy.jpg')" }}>
        ...
        <div className='w-[1515px] ml-[-147px]'>
        <div className="bg-cover h-[450px] opacity-90 mb-16 bg-blue-900 rounded-lg shadow-xl overflow-hidden" style={{ backgroundImage: "url('https://t4.ftcdn.net/jpg/09/29/15/01/360_F_929150196_lToTZymFCw9t47PDA2MsuSTvhd0CcEU1.jpg')" }}>
        ...
        {/* CTA Section */}
        <div className='w-[1515px] ml-[-147px]'>
        <div className="bg-cover text-center py-16 bg-blue-600 text-white rounded-lg shadow-xl"style={{ backgroundImage: "url('https://t3.ftcdn.net/jpg/08/00/56/76/360_F_800567668_rswDUNh6no2SbMwVaYgjlCCIB5neuV7G.jpg')" }}>
